\documentclass[justified,notitlepage]{tufte-book}   	% use "amsart" instead of "article" for AMSLaTeX format
...
\usepackage[plain]{fancyref}								% TeX will automatically convert eps --> pdf in pdflatex		
\usepackage{amssymb}
\usepackage{amsthm}
